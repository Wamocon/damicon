...
export function EskalationsFormular() {
  ...
  return (
    <form action={eskalationAction} className="flex items-center gap-2">
      ...
      <button
        type="submit"
        className="inline-flex h-11 items-center gap-1.5 rounded-lg border border-border bg-card px-3 text-sm font-semibold text-foreground transition hover:border-primary md:h-8 md:text-[11px]"
      >
