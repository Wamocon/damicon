...
export const PRUEFPUNKTE: Pruefpunkt[] = [
  // ---- Steuer ---------------------------------------------------------------------------
  {
    ...
    frage: "Ab welchem Umsatz muss sich ein Betrieb in Kasachstan für die Mehrwertsteuer registrieren, wie lange hat er dafür Zeit und wie hoch ist der Satz?",
  ...
  },
  {
    ...
    frage: "Welche Pflichten gelten für die elektronische Transportbegleitung ESUTD und welche Strafen drohen bei Verstößen?",
  ...
  },
  {
    ...
    frage: "Welche Steuern und Sozialabgaben muss ein Arbeitgeber in Kasachstan auf Löhne abführen und bis wann?",
  ...
  // ---- Audit ----------------------------------------------------------------------------
  {
    id: "au-pflicht",
    bereich: "audit",
    titel: "Pflicht zur Abschlussprüfung",
    frage: "Wann ist eine Abschlussprüfung (Audit) der Jahresabschlüsse in Kasachstan verpflichtend?",
  ...
  },
  {
    ...
    frage: "Welche Unterlagen muss ein Betrieb in Kasachstan für Prüfungen vorhalten und wie lange aufbewahren?",
  ...
  },
  {
    ...
    bereich: "audit",
    titel: "Rückverfolgbarkeit und Kühlkette",
    frage: "Welche Anforderungen gelten in Kasachstan an die Rückverfolgbarkeit und die Kühlkette bei Lebensmitteln wie frischen Beeren?",
  ...
  // ---- Recht ----------------------------------------------------------------------------
  {
    id: "re-datenschutz",
    bereich: "recht",
    titel: "Datenschutz: Vorfälle und Meldefristen",
  ...
  },
  {
    ...
    frage: "Welche Pflichten gelten in Kasachstan für Arbeitszeit, Arbeitsschutz und Unterweisung von Saisonkraeften?",
  ...
  // ---- Risiko ---------------------------------------------------------------------------
  {
    id: "ri-fristen",
    bereich: "risiko",
    titel: "Überfällige gesetzliche Fristen",
  ...
  },
  {
    ...
    frage: "Welche Folgen haben Temperaturabweichungen in der Kühlkette für die Verkehrsfähigkeit und Haftung bei Lebensmitteln?",
  ...
  },
  {
    ...
    frage: "Welche Bußgelder und Sanktionen drohen einem Betrieb in Kasachstan bei Verstößen gegen Steuer- und Meldepflichten?",
