...
export const de: HandbuchTexte = {
  ...
  bedienung: {
    ...
    teile: [
      ...
      {
        titel: "Suche",
        text: "Auf breiten Bildschirmen ist die Suche ein Feld in der Kopfzeile: hineinklicken und tippen, die Treffer erscheinen direkt darunter. Auf schmaleren Bildschirmen steht an derselben Stelle, direkt hinter dem Pfad, eine Lupe, auf dem Telefon links neben der Glocke; sie öffnet das Suchfenster dort, wo sie sitzt. Mit der Tastatur führen / oder Strg+K (Mac: ⌘K) von jeder Seite in die Suche. Die Suche findet die Übersicht, die Bereiche, die Module und die Seiten Sicherheit, Compliance-Bericht und Handbuch, und zwar nur, was die Rolle auch in der Navigation sieht. Gesucht wird nach Namen in der eingestellten Sprache, Umlaute dürfen fehlen: „Kuhlkette“ findet „Kühlkette“. Darunter stehen unter „Erwähnt in“ die Module, in deren Beschreibung der Begriff vorkommt, mit der Stelle im Text. Pfeiltasten wählen einen Treffer, die Eingabetaste öffnet ihn, Esc schließt die Trefferliste oder das Suchfenster. Bei leerem Feld stehen die zuletzt selbst geöffneten Seiten. Findet die Suche nichts, bietet sie an, die KI mit dem Begriff zu fragen. Reihenblöcke, Chargen, Pflücker und Dokumente findet sie noch nicht.",
      },
      {
