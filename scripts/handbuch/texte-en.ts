...
export const en: HandbuchTexte = {
  ...
  bedienung: {
    ...
    teile: [
      ...
      {
        titel: "Search",
        text: "On wide screens the search is a field in the header: click into it and type, and the results appear right below it. On narrower screens a magnifier sits in the same place, right after the breadcrumb, and on the phone to the left of the bell; it opens the search window where it sits. From the keyboard, / or Ctrl+K (Mac: ⌘K) takes you to the search from any page. The search finds the overview, the zones, the modules and the pages Security, Compliance report and Handbook, and only what the role also sees in the navigation. It searches names in the selected language. Below them, under “Mentioned in”, it lists the modules whose description contains the term, with the passage. Arrow keys choose a result, Enter opens it, Esc closes the result list or the search window. With an empty field it lists the pages you opened yourself most recently. If nothing matches, it offers to ask the AI about the term. It does not yet find row blocks, batches, pickers or documents.",
      },
      {
