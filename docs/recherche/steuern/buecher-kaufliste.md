...
**Kein Titel ist ein E-Book.** Jedes gekaufte Buch muss gescannt und durch Texterkennung, bevor es in die Vektordatenbank kann. Rechne mit etwa einer Stunde Handarbeit je 200 Seiten. Das ist der eigentliche Preis dieser Liste, nicht die Tenge.
...
**Viele LEM-Links zeigen auf die Kategorieseite, nicht auf das Produkt.** Der Verlag fuehrt nicht jeden Titel unter einer eigenen Adresse. Auf der Kategorieseite nach dem Titel suchen. Das ist eine Schwaeche der Quelle, keine der Liste, und wurde nicht durch geratene Produktadressen kaschiert.
